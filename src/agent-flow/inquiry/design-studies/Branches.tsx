...
export const InquiryBranches: React.FC = () => {
  ...
  const accent = step === 4 ? '#80dec9' : '#ffbd8e';
  return <AbsoluteFill style={{background:'#211f25', color:'#fff3e6', fontFamily:FONT}}>
    ...
    <svg width={1920} height={1080} style={{position:'absolute'}}>
      <path d="M235 485H985Q1090 485 1110 390T1235 305H1750 M985 485Q1100 485 1150 565T1490 605" fill="none" stroke="#665554" strokeWidth={18} strokeLinecap="round" />

...
import { roundedPath, pointAtFraction, type Point } from "../../../shared/orthogonalRouting";
		...
		<AbsoluteFill style={{ background: COLORS.bg, fontFamily: jpFont, color: COLORS.textMain }}>
			...
			<svg width={CANVAS_W} height={CANVAS_H} style={{ position: "absolute", inset: 0 }}>
				<defs>
					...
					<ArrowMarkerDefs prefix="ci-arrow-" colors={MARKER_COLORS} />
				</defs>
	...
	return (
		<g>
			...
			<path
				...
				strokeLinecap="round"
				markerEnd={`url(#${arrowMarkerId("ci-arrow-", stroke)})`}
			/>
